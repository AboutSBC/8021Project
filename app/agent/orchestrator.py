...
class Orchestrator(ToolCallAgent):
    ...
    def initialize_helper(self) -> "Orchestrator":
        """Initialize basic components synchronously."""
        self.browser_context_helper = BrowserContextHelper(self)
        return self

    @classmethod
    async def create(cls, **kwargs) -> "Orchestrator":
        """Factory method to create and properly initialize a Orchestrator instance."""
        instance = cls(**kwargs)
